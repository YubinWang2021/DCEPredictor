...
DCE_ANN_KEYS = ['bbox', 'dp_x', 'dp_y', 'dp_I', 'dp_U', 'dp_V', 'dp_masks']
DCE_IUV_KEYS = ['dp_x', 'dp_y', 'dp_I', 'dp_U', 'dp_V']
...
def init_from_coco_json_file(json_file):
    ...
    if 'densepose_coco_2014_train' in json_file:
        image_root = '/data/dataset/coco2014/train2014'
    elif 'densepose_coco_2014_val' in json_file or 'densepose_coco_2014_minival' in json_file:
        image_root = '/data/dataset/coco2014/val2014'
    else:
        image_root = ''
    ...
    for ann in annotations:
        if any([k not in ann for k in DCE_ANN_KEYS]):
            continue
