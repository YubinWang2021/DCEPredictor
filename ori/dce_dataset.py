...
from dataset_utils import DCE_ANN_KEYS, DCE_IUV_KEYS, init_from_coco_json_file
from dataset_utils import extract_dp_clothes_mask, extract_segmentation_mask
...
if __name__ == '__main__':
    test = ['/data/dataset/coco2014/densepose_coco_2014_train.json',
